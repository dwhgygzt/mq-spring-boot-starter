...
public class TopicMessage implements Message {
     ...
     * 当前发送失败后，已经被重试发送的次数
     */
    private int currentRetyPubishCount;

    /**
     * 当前消费失败后，已经被重试消费的次数
     */
    private int currentRetyConsumCount;
    ...
    public int getCurrentRetyPubishCount() {
        return currentRetyPubishCount;
    }

    public void setCurrentRetyPubishCount(int currentRetyPubishCount) {
        this.currentRetyPubishCount = currentRetyPubishCount;
    }

    public int getCurrentRetyConsumCount() {
        return currentRetyConsumCount;
    }

    public void setCurrentRetyConsumCount(int currentRetyConsumCount) {
        this.currentRetyConsumCount = currentRetyConsumCount;
    }
}
